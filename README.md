...
```
export SONAR_TOKEN=squ_e664db81a7af3fdc654aab40d1947df15b67d7bb
#sonar_token set in env like below

export SONAR_TOKEN=squ_[lotsofnumbers]

mvn clean verify sonar:sonar -Dsonar.host.url=https://supreme-parakeet-9gv6vxxqj7cpqwr-9000.app.github.dev -Dsonar.coverage.exclusions=**/*
```
